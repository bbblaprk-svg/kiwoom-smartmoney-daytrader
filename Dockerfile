...
LABEL io.pulse-edge.project="PULSE_EDGE" io.pulse-edge.runtime="3.8.19_STORAGE_ISOLATION"
ENV PYTHONDONTWRITEBYTECODE=1 PYTHONUNBUFFERED=1 PIP_NO_CACHE_DIR=1
WORKDIR /app
COPY PULSE_EDGE_GREENFIELD_3_8_19_STORAGE_ISOLATION_SOURCE.tar.gz /tmp/source.tar.gz
