...
LABEL io.pulse-edge.project="PULSE_EDGE" io.pulse-edge.runtime="3.9.1_HIDDEN_GEM_PUBLIC_READER_R1"
ENV PYTHONDONTWRITEBYTECODE=1 PYTHONUNBUFFERED=1 PIP_NO_CACHE_DIR=1
WORKDIR /app
COPY PULSE_EDGE_GREENFIELD_3_9_1_HIDDEN_GEM_PUBLIC_READER_R1_SOURCE.tar.gz /tmp/source.tar.gz
