...
LABEL io.pulse-edge.project="PULSE_EDGE" io.pulse-edge.runtime="3.9.0_HIDDEN_GEM_PURE"
ENV PYTHONDONTWRITEBYTECODE=1 PYTHONUNBUFFERED=1 PIP_NO_CACHE_DIR=1
WORKDIR /app
COPY PULSE_EDGE_GREENFIELD_3_9_0_HIDDEN_GEM_PURE_SOURCE.tar.gz /tmp/source.tar.gz
