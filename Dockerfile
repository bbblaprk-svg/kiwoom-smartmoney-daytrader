...
LABEL io.pulse-edge.project="PULSE_EDGE" io.pulse-edge.runtime="3.8.20_SCORE_DIAGNOSTICS"
ENV PYTHONDONTWRITEBYTECODE=1 PYTHONUNBUFFERED=1 PIP_NO_CACHE_DIR=1
WORKDIR /app
COPY PULSE_EDGE_GREENFIELD_3_8_20_SCORE_DIAGNOSTICS_SOURCE.tar.gz /tmp/source.tar.gz
