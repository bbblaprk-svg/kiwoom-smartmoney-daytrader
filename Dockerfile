# PULSE EDGE 2.1.11.9 SCOUT_FUNNEL_CPU_SAFE — R7 final audited deployment harness
...
WORKDIR /app
COPY PULSE_EDGE_CORE_2_1_3_RUNTIME_2_1_11_9_SCOUT_FUNNEL_CPU_SAFE_R7_SOURCE.tar.gz /tmp/pulse-source.tar.gz
RUN python - <<'PY'
