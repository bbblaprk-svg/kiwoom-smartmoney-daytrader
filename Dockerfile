# PULSE EDGE 2.1.12 HIDDEN_GEM_V1 — decision-engine replacement one-shot deployment harness
FROM python:3.12-slim
LABEL io.pulse-edge.project="PULSE_EDGE" io.pulse-edge.runtime="2.1.12_HIDDEN_GEM_V1"
...
WORKDIR /app
COPY PULSE_EDGE_CORE_2_1_3_RUNTIME_2_1_12_HIDDEN_GEM_V1_SOURCE.tar.gz /tmp/pulse-source.tar.gz
RUN python - <<'PY'
import hashlib, pathlib, tarfile
p=pathlib.Path('/tmp/pulse-source.tar.gz')
expected='13a21c5b1c191be2651987182ffeb5e06f1275946d850f679c0e862a9616cbe1'
