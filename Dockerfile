# PULSE EDGE 2.1.11.9 SCOUT_FUNNEL_CPU_SAFE — R5 deployment harness
...
WORKDIR /app
COPY PULSE_EDGE_CORE_2_1_3_RUNTIME_2_1_11_9_SCOUT_FUNNEL_CPU_SAFE_R5_SOURCE.tar.gz /tmp/pulse-source.tar.gz
RUN python - <<'PY'
import hashlib, pathlib, tarfile
p=pathlib.Path('/tmp/pulse-source.tar.gz')
expected='08ecfd38ea8f1cb9433dd64d585f4f01ea69654c6636a73d4cada814fd52fa29'
