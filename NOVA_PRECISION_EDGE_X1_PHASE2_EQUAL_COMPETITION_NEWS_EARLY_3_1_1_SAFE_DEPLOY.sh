...
VERSION='NOVA-PRECISION-EDGE-X1-PHASE2-EQUAL-COMPETITION-NEWS-EARLY-3.1.1'
CURRENT_CONTAINER="${NOVA_CURRENT_CONTAINER:-quant-nova}"
DOCKERFILE_NAME='NOVA_PRECISION_EDGE_X1_PHASE2_EQUAL_COMPETITION_NEWS_EARLY_3_1_1.Dockerfile'
EXPECTED_DOCKERFILE_SHA256='d530bfd072c198a78684a5d36454a149d3dfe2794fee9bd83fba3f5bb4f548db'
...
IMAGE_TAG="quant-nova:equal-news-3-1-1-${STAMP}"
BACKUP_CONTAINER="quant-nova-backup-before-equal-news-3-1-1-${STAMP}"
CANARY_CONTAINER="quant-nova-canary-equal-news-3-1-1-${STAMP}"
BUILD_CONTEXT=''
CUTOVER_STARTED=0
...
BUILD_CONTEXT="$(mktemp -d -t nova-equal-news-311-build.XXXXXX)"
...
assert edge.get('version')=='NOVA-PRECISION-EDGE-X1-PHASE2-EQUAL-COMPETITION-NEWS-EARLY-3.1.1', edge.get('version')
