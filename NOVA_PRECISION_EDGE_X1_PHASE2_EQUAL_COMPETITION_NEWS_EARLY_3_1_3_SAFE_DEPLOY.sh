...
[[ "$(label io.quantnova.nxt_time_gate)" == 'NEW_SIGNALS_1540_2000_PRIOR_SNAPSHOT_DISPLAY_ONLY' ]] || fail 'NXT time gate mismatch'
[[ "$(label io.quantnova.signal_occurrence)" == 'DAY_VENUE_CODE_DISTINCT_IGNITION_CYCLES' ]] || fail 'signal occurrence contract mismatch'
[[ "$(label io.quantnova.signal_display_continuity)" == 'LAST_VALID_SNAPSHOT_NEVER_BLANK_ON_WINDOW_CLOSE_OR_TEMP_GAP' ]] || fail 'signal display continuity contract mismatch'
...
say "NXT_TIME_GATE=NEW_SIGNALS_1540_2000_PRIOR_SNAPSHOT_DISPLAY_ONLY"
say "SIGNAL_OCCURRENCE=DISTINCT_IGNITION_CYCLES"
say "SIGNAL_DISPLAY_CONTINUITY=LAST_VALID_SNAPSHOT_DISPLAY_ONLY"
