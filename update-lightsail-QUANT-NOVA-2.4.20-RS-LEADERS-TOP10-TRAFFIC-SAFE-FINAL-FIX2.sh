...
ZIP_NAME="QUANT_NOVA_2.4.20_RS_LEADERS_TOP10_TRAFFIC_SAFE_FINAL_FIX2.zip"
ROOT_NAME="nova2420"
EXPECTED_ZIP_SHA256="7a2c2b0e2563a36429bccb188838c5146d7b38ed829b3cb062f4811218deb40b"
...
curl -fsS --max-time 5 http://127.0.0.1:${HOST_PORT}/api/nova | python3 -c 'import sys,json;j=json.load(sys.stdin); assert j.get("version")=="NOVA-2.4.20"; print("NOVA_API=OK rows=",len(j.get("rows") or []))'
