#!/usr/bin/env bash
set -Eeuo pipefail
# PULSE EDGE 2.1.11.9 R7 — ten-round audited scout-funnel + CPU-safe deployment; robust stale-route reconciliation by managed container name/run marker; Docker-network canary; no host-port/userland-proxy dependency. Run with bash, never source this file.
...
EXPECTED_DF_SHA=191e525f0a4410cfe48a4439146a461e2b1420e74bfc3a61e74c62ddf9717e83
EXPECTED_SRC_SHA=12a3065c7ed866bd51d3b3c254fb030d962e02064eb227945e40151c87c1849c
SRC_NAME=PULSE_EDGE_CORE_2_1_3_RUNTIME_2_1_11_9_SCOUT_FUNNEL_CPU_SAFE_R7_SOURCE.tar.gz
