...
SRC_NAME="PULSE_EDGE_GREENFIELD_3_9_1_HIDDEN_GEM_PUBLIC_READER_SOURCE.tar.gz"
EXPECTED_SRC_SHA="97b0e5ce02c6c7cf4cbc0054ef64fe7106bf616e4a4f3d69d38673d345879d8d"
EXPECTED_DF_SHA="ee5434bfbf98ca0ce39f177802a1d1bd8f117b38644a7159778b2f95313e2275"
MODE="${1:-deploy}"
SCRIPT_DIR="$(cd -- "$(dirname -- "${BASH_SOURCE[0]}")" && pwd -P)"
RUN_ID="$(date +%Y%m%d-%H%M%S)-$$"
RUN_DIR="$BASE/deployments/$RUN_ID"
CANARY_DATA="$RUN_DIR/canary-data"
IMG="pulse-edge:gf391-hidden-$RUN_ID"
CANARY="pulse-edge-gf391-canary-$RUN_ID"
LIVE="pulse-edge-gf391-live-$RUN_ID"
OLD=""
OLD_RUNNING=false
OLD_RESTART="no"
CUTOVER=0
...
log "[0/13] HIDDEN-GEM-PURE FRESH-INSTALL $RELEASE"
log "BASE=$BASE"
