...
RELEASE="3.8.26_EARLY_VISIBLE_PIPELINE"
...
SRC_NAME="PULSE_EDGE_GREENFIELD_3_8_26_EARLY_VISIBLE_PIPELINE_SOURCE.tar.gz"
EXPECTED_SRC_SHA="13ec7511421111a2db30129a8a4a060676b1d58e0754724a1c885cbd4ccecfe7"
EXPECTED_DF_SHA="17208dadfb6e3395170ab3238a004f722537fce8ed89d8807c6319a725c01fe4"
MODE="${1:-deploy}"
...
fixed={
'PULSE_RELEASE':'3.8.26_EARLY_VISIBLE_PIPELINE','PULSE_FEED_ENABLED':'true','PULSE_DATA_DIR':'/app/data/pulse_edge',
...
import json,sys
q=json.load(open(sys.argv[1])); assert q['release']=='3.8.26_EARLY_VISIBLE_PIPELINE' and q['ready'] is True and q['feed_enabled'] is False
PY
  fi
...
import json,sys
q=json.load(open(sys.argv[1])); assert q.get('release')=='3.8.26_EARLY_VISIBLE_PIPELINE' and isinstance(q.get('rows'),list),q
...
import json,sys
h=json.load(open(sys.argv[1])); assert h.get('runtime_safety_release')=='3.8.26_EARLY_VISIBLE_PIPELINE'
PY
...
import json,sys
h=json.load(open(sys.argv[1])); assert h.get('runtime_safety_release')=='3.8.26_EARLY_VISIBLE_PIPELINE',h
