...
ZIP_NAME="kiwoom-unified-edge-v3.2.1-NEWS151-HOTFIX.zip"
SOURCE_DIR_NAME="kiwoom-unified-edge-v3.2.1"
EXPECTED_ZIP_SHA256="0fa91680ed7050ac1cdd7da0adcfc3a355800ff44c6c69d5bc814b3cfa93513b"
...
grep -q '"version":"1.5.1-unified"' "$TMP_ROOT/news-health.json" || fail "News Radar 실행 버전이 1.5.0-unified가 아닙니다."
