...
RELEASE="2.1.3-krx-nxt-isolation-stability"
EXPECTED_VERSION="2.1.3-krx-nxt-isolation-stability"
EXPECTED_PACKAGE_RELEASE="2.1.3_KRX_NXT_ISOLATION_STABILITY"
SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
SOURCE_ARCHIVE="${SCRIPT_DIR}/PULSE_EDGE_2_1_3_KRX_NXT_ISOLATION_STABILITY_SOURCE.tar.gz"
DOCKERFILE="${SCRIPT_DIR}/Dockerfile"
EXPECTED_SOURCE_SHA="cf2b1dceb8ad3417b1f9f074550e28660a6f59a20c22246f9cf0e2422277f6df"
...
PULSE_IMAGE="${PULSE_IMAGE:-pulse-edge:2.1.3-krx-nxt-isolation-stability}"
...
CADDY_BACKUP="${PULSE_CADDYFILE}.pre-2.1.3-${STAMP}"; cp "$PULSE_CADDYFILE" "$CADDY_BACKUP"
