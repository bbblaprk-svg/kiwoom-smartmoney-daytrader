...
SRC_NAME="PULSE_EDGE_GREENFIELD_3_9_0_HIDDEN_GEM_PURE_SOURCE.tar.gz"
EXPECTED_SRC_SHA="79e6a1d5e1694e60b84bbee2f87406ee9c1c82bd6646a019aaea7f467ad4b9f4"
EXPECTED_DF_SHA="8487827decea18895fb661bb8645f5e9548284594b323acc7478e50e48f8025c"
MODE="${1:-deploy}"
SCRIPT_DIR="$(cd -- "$(dirname -- "${BASH_SOURCE[0]}")" && pwd -P)"
RUN_ID="$(date +%Y%m%d-%H%M%S)-$$"
RUN_DIR="$BASE/deployments/$RUN_ID"
CANARY_DATA="$RUN_DIR/canary-data"
IMG="pulse-edge:gf390-hidden-$RUN_ID"
CANARY="pulse-edge-gf390-canary-$RUN_ID"
LIVE="pulse-edge-gf390-live-$RUN_ID"
OLD=""
OLD_RUNNING=false
OLD_RESTART="no"
CUTOVER=0
...
fixed={
'PULSE_RELEASE':'3.9.0_HIDDEN_GEM_PURE','PULSE_FEED_ENABLED':'true','PULSE_DATA_DIR':'/app/data/pulse_edge',
...
import json,sys
q=json.load(open(sys.argv[1])); assert q['release']=='3.9.0_HIDDEN_GEM_PURE' and q['ready'] is True and q['feed_enabled'] is False
PY
  fi
...
import json,sys
h=json.load(open(sys.argv[1])); assert h.get('runtime_safety_release')=='3.9.0_HIDDEN_GEM_PURE'
PY
...
import json,sys
h=json.load(open(sys.argv[1])); assert h.get('runtime_safety_release')=='3.9.0_HIDDEN_GEM_PURE',h
