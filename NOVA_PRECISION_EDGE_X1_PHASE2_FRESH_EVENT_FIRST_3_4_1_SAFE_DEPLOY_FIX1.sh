#!/usr/bin/env bash
# NOVA PRECISION EDGE X1 PHASE2 · FRESH EVENT FIRST · 3.4.1 · CURRENT-DAY ACCELERATION ONLY
# Safe build/canary/cutover with automatic rollback. No runtime source patching.
set -Eeuo pipefail

PRODUCT='NOVA PRECISION EDGE X1 PHASE2 · FRESH EVENT FIRST · 3.4.1'
VERSION='NOVA-PRECISION-EDGE-X1-PHASE2-FRESH-EVENT-FIRST-3.4.1'
CURRENT_CONTAINER="${NOVA_CURRENT_CONTAINER:-quant-nova}"
DOCKERFILE_NAME='NOVA_PRECISION_EDGE_X1_PHASE2_FRESH_EVENT_FIRST_3_4_1.Dockerfile'
EXPECTED_DOCKERFILE_SHA256='b72dec14d3ff7a7d5a47c2d34fa37dced753ee776d574ebe13aa5cbd97e375cd'
...
IMAGE_TAG="quant-nova:fresh-event-3-4-1-${STAMP}"
BACKUP_CONTAINER="quant-nova-backup-before-fresh-event-3-4-1-${STAMP}"
CANARY_CONTAINER="quant-nova-canary-fresh-event-3-4-1-${STAMP}"
BUILD_CONTEXT=''
CUTOVER_STARTED=0
...
BUILD_CONTEXT="$(mktemp -d -t nova-fresh-event-341-build.XXXXXX)"
...
assert edge.get('version')=='NOVA-PRECISION-EDGE-X1-PHASE2-FRESH-EVENT-FIRST-3.4.1', edge.get('version')
