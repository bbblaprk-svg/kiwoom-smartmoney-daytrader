#!/usr/bin/env bash
set -Eeuo pipefail
# PULSE EDGE 2.1.11.9 R1 — scout-funnel + CPU-safe deployment; verification-release fix only. Run with bash, never source this file.
...
EXPECTED_DF_SHA=df4c08c4dd3542dbc54c74bd44cba309071f2cc81e90b7e3aa3bedd8f917b7ae
EXPECTED_SRC_SHA=3d4acac39e6984eaf6f7884a90ea047c5efd42eb1af446a673b54ea73fbb43d1
SRC_NAME=PULSE_EDGE_CORE_2_1_3_RUNTIME_2_1_11_9_SCOUT_FUNNEL_CPU_SAFE_R1_SOURCE.tar.gz
