#!/usr/bin/env bash
# Revision: PHASE2-EARLY-SURGE-2_1
set -Eeuo pipefail

PRODUCT='NOVA PRECISION EDGE X1 PHASE2'
VERSION='NOVA-PRECISION-EDGE-X1-PHASE2-2.1.0'
CURRENT_CONTAINER="${NOVA_CURRENT_CONTAINER:-quant-nova}"
DOCKERFILE_NAME='QUANT_NOVA_PRECISION_EDGE_X1_PHASE2.Dockerfile'
EXPECTED_DOCKERFILE_SHA256='700ca25ea22bed4103b1b7a7ba734e3a45a8fe590922b9c83fd52eab48410c24'
...
assert edge.get("version")=="NOVA-PRECISION-EDGE-X1-PHASE2-2.1.0",edge
...
assert j.get("ok") and j.get("version")=="NOVA-PRECISION-EDGE-X1-PHASE2-2.1.0",j
