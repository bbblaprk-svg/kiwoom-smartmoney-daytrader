#!/usr/bin/env bash
# Revision: PHASE2-CUTOVER-CANARY-LOGFIX1
set -Eeuo pipefail

PRODUCT='NOVA PRECISION EDGE X1 PHASE2'
VERSION='NOVA-PRECISION-EDGE-X1-PHASE2-2.0.0'
CURRENT_CONTAINER="${NOVA_CURRENT_CONTAINER:-quant-nova}"
DOCKERFILE_NAME='QUANT_NOVA_PRECISION_EDGE_X1_PHASE2.Dockerfile'
EXPECTED_DOCKERFILE_SHA256='cb1f91c1edfd8a5bbe8733007380ea7e74a65ed66b64d766340f5cc6e6de7aff'
...
assert edge.get("version")=="NOVA-PRECISION-EDGE-X1-PHASE2-2.0.0",edge
...
assert j.get("ok") and j.get("version")=="NOVA-PRECISION-EDGE-X1-PHASE2-2.0.0",j
