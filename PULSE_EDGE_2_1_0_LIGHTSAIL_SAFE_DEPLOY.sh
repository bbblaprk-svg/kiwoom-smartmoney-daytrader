...
# PULSE EDGE 2.1.0 — AWS Lightsail safe deployment
...
RELEASE="2.1.0-live-certification"
SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
SOURCE_ARCHIVE="${SCRIPT_DIR}/PULSE_EDGE_2_1_0_LIVE_CERTIFICATION_SOURCE.tar.gz"
DOCKERFILE="${SCRIPT_DIR}/Dockerfile"
EXPECTED_SOURCE_SHA="1c24282f0e7cfbd68c225815b2c77f9213abd0c09cd2c7b5a1b3918c8ae7cb9b"
EXPECTED_DOCKERFILE_SHA="0dfb04c1fc61af67b0a76a6364af1b6ecbe9e53900a11337f164c3ea4632008b"
