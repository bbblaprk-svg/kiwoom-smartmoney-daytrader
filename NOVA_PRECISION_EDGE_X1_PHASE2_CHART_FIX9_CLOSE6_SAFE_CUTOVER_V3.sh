#!/usr/bin/env bash
# Revision: PHASE2-CHART-FIX9-CLOSE6-3_0_6-CANARY-V3
set -Eeuo pipefail

PRODUCT='NOVA PRECISION EDGE X1 PHASE2 · CHART FIX9 CLOSE6 · CANARY V3'
...
if chart.get("mode")=="CLOSE_HANDOFF_PENDING":
    ...
    assert meta.get("mode")=="CLOSE_HANDOFF_PENDING",meta
    assert meta.get("persistedClose20Preserved") is True,meta
