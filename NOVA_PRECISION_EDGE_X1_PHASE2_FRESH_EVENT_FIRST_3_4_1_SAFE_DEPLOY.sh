...
[[ "$(label io.quantnova.rank_priority)" == 'CONFIRMED_EVENT_THEN_ACCEL_RECENCY_THEN_RANK_VELOCITY' ]] || fail 'rank priority mismatch'
[[ "$(label io.quantnova.stagnation_policy)" == 'CONFIRMED_EVENT_EXPIRES_120S_WITHOUT_NEW_ACCEL' ]] || fail 'stagnation policy mismatch'
