...
RELEASE="2.2.0-fresh-rotation-candidate-history"
EXPECTED_VERSION="2.2.0-fresh-rotation-candidate-history"
EXPECTED_PACKAGE_RELEASE="2.2.0_FRESH_ROTATION_CANDIDATE_HISTORY"
SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
SOURCE_ARCHIVE="${SCRIPT_DIR}/PULSE_EDGE_2_2_0_FRESH_ROTATION_CANDIDATE_HISTORY_SOURCE.tar.gz"
DOCKERFILE="${SCRIPT_DIR}/Dockerfile"
EXPECTED_SOURCE_SHA="d3e3c5e84f1aa54434eb69f94df88e38f4dc05577f9cc83123b41eb273d4319e"
EXPECTED_DOCKERFILE_SHA="96bca93931e231066ae9d1a9428d7cc7b673408ceada89c760d07f625e647060"
...
PULSE_IMAGE="${PULSE_IMAGE:-pulse-edge:2.2.0-fresh-rotation-candidate-history}"
...
CADDY_BACKUP="${PULSE_CADDYFILE}.pre-2.2.0-${STAMP}"; cp "$PULSE_CADDYFILE" "$CADDY_BACKUP"
