#!/usr/bin/env bash
set -Eeuo pipefail
# PULSE EDGE 2.1.11.9 — scout-funnel + CPU-safe deployment. Run with bash, never source this file.
...
EXPECTED_DF_SHA=664f8877ae6677babb6e8a3f39831e8193d22b783158c2c484e16d7f837b8a38
EXPECTED_SRC_SHA=0d6c34169012c0db539148f9c950abccd0b9b84afa836177386dda0606e957f5
SRC_NAME=PULSE_EDGE_CORE_2_1_3_RUNTIME_2_1_11_9_SCOUT_FUNNEL_CPU_SAFE_SOURCE.tar.gz
