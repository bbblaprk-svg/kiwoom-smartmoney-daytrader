...
EXPECTED_DF_SHA="9678f57552b28048ba23b2061a3101efbfb0d09a27b1159c6e98b4d303fb95b0"
MODE="${1:-deploy}"
SCRIPT_DIR="$(cd -- "$(dirname -- "${BASH_SOURCE[0]}")" && pwd -P)"
RUN_ID="$(date +%Y%m%d-%H%M%S)-$$"
RUN_DIR="$BASE/deployments/$RUN_ID"
CANARY_DATA="$RUN_DIR/canary-data"
IMG="pulse-edge:gf3826-hidden-$RUN_ID"
CANARY="pulse-edge-gf3826-canary-$RUN_ID"
LIVE="pulse-edge-gf3826-live-$RUN_ID"
OLD=""
OLD_RUNNING=false
OLD_RESTART="no"
CUTOVER=0
