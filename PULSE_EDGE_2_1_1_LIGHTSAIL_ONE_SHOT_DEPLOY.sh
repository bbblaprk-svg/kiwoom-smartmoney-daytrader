...
EXPECTED_VERSION="2.1.1-preopen-live-gate"
EXPECTED_PACKAGE_RELEASE="2.1.1_PREOPEN_LIVE_GATE"
SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
SOURCE_ARCHIVE="${SCRIPT_DIR}/PULSE_EDGE_2_1_1_PREOPEN_LIVE_FINAL_SOURCE.tar.gz"
DOCKERFILE="${SCRIPT_DIR}/Dockerfile"
EXPECTED_SOURCE_SHA="39a8f7a06e11163254c25f9214cc9b517dc5c331923ebcec14c9faf4897dac92"
...
PULSE_IMAGE="${PULSE_IMAGE:-pulse-edge:2.1.1-preopen-live-gate}"
...
CADDY_BACKUP="${PULSE_CADDYFILE}.pre-2.1.1-${STAMP}"; cp "$PULSE_CADDYFILE" "$CADDY_BACKUP"
