...
ZIP_NAME="kiwoom-unified-edge-v3.2.1-NEWS150-FINAL.zip"
SOURCE_DIR_NAME="kiwoom-unified-edge-v3.2.1"
EXPECTED_ZIP_SHA256="ee5da2ca3c8150cf4f46b958861054e8241412bb6f85e96aba692e2cb0167f28"
OLD_APP_DIR="$HOME/kiwoom-smartmoney-daytrader"
NEW_APP_DIR="$HOME/kiwoom-unified-edge"
TRADER_IMAGE="kiwoom-unified:v3.2.1"
NEWS_IMAGE="kiwoom-news-radar:1.5.0-unified"
...
# v3.2.1 compatibility hotfix: 기존 trader와 동일하게 APP_ACCESS_TOKEN 최소 길이를 8자로 통일한다.
...
grep -q '"version":"1.5.0-unified"' "$TMP_ROOT/news-health.json" || fail "News Radar 실행 버전이 1.5.0-unified가 아닙니다."
...
printf '내부 뉴스   : news-radar v1.5.0-unified (AWS 내부망)\n'
