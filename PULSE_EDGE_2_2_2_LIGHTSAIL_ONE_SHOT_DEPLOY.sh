...
RELEASE="2.2.2-early-buy-expansion"
EXPECTED_VERSION="2.2.2-early-buy-expansion"
EXPECTED_PACKAGE_RELEASE="2.2.2_EARLY_BUY_EXPANSION"
SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
SOURCE_ARCHIVE="${SCRIPT_DIR}/PULSE_EDGE_2_2_2_EARLY_BUY_EXPANSION_SOURCE.tar.gz"
DOCKERFILE="${SCRIPT_DIR}/Dockerfile"
EXPECTED_SOURCE_SHA="2389b0814984ea035d63e4793120c9f59ae283cf180059abb78bda8ff702db53"
EXPECTED_DOCKERFILE_SHA="ddb69c5b139b2d30003944fdf9df918a62170c878b1ded949d9515a91106ddd8"
...
PULSE_IMAGE="${PULSE_IMAGE:-pulse-edge:2.2.2-early-buy-expansion}"
...
CADDY_BACKUP="${PULSE_CADDYFILE}.pre-2.2.2-${STAMP}"; cp "$PULSE_CADDYFILE" "$CADDY_BACKUP"
