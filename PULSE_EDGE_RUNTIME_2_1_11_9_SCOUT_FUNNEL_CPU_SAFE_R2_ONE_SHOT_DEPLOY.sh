#!/usr/bin/env bash
set -Eeuo pipefail
# PULSE EDGE 2.1.11.9 R2 — scout-funnel + CPU-safe deployment; full release-reference audit + soak-release fix. Run with bash, never source this file.
...
SRC_NAME=PULSE_EDGE_CORE_2_1_3_RUNTIME_2_1_11_9_SCOUT_FUNNEL_CPU_SAFE_R2_SOURCE.tar.gz
