...
DOCKERFILE="QUANT_NOVA_R492_FEED_RECOVERY2_COLDSTART.Dockerfile"
EXPECTED_SHA="0fb4c75ac9db18029ad7b9dd0d4b8957eae0d29981863aa1d09fff34ef49fcb9"
EXPECTED_VERSION="NOVA-3.3.5-R492-FEED-RECOVERY2-COLDSTART"
IMAGE="quant-nova:r492-feed-recovery2-coldstart"
STAMP="$(date +%Y%m%d-%H%M%S)"
BACKUP="${APP}-pre-recovery2-${STAMP}"
WORK="$(mktemp -d /tmp/nova-recovery2.XXXXXX)"
