...
ZIP_NAME="kiwoom-unified-edge-v3.2.19-NEWS156-NXT-ROUTE-PROBE.zip"
SOURCE_DIR_NAME="kiwoom-unified-edge-v3.2.19"
EXPECTED_ZIP_SHA256="cd6f95883d583a3bd68463c74e4401215e85bcc4215b1717971f7d425e714a67"
...
rollback(){
  local ec=$?
  [[ $ec -eq 0 ]] && return
  printf '\n[자동복구] v3.2.19 적용 실패 — 기존 컨테이너로 복구합니다.\n' >&2
...
say "v3.2.19 NXT ROUTE PROBE + News 1.5.6 파일 받기"
